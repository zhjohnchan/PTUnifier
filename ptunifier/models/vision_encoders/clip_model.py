...
class VisualTransformer(nn.Module):
    ...
    def get_pos_encoded_cls_embed(self):
        return self.class_embedding + self.positional_embedding[:1]
...
def adapt_position_encoding(model, patch_size=32, after=384, suffix='visual.positional_embedding'):
    ...
    pos_embed = torch.nn.functional.interpolate(pos_embed.permute((2, 0, 1)).unsqueeze(0),
