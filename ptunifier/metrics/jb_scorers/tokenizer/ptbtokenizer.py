...
class PTBTokenizer:
    ...
    def tokenize_list(self, captions_list):
        cmd = ['java', '-cp', STANFORD_CORENLP_3_4_1_JAR,
               'edu.stanford.nlp.process.PTBTokenizer',
               '-preserveLines', '-lowerCase']
        ...
        for line in lines:
            ...
            final_tokenized_captions_list.append(tokenized_caption)

        return final_tokenized_captions_list
